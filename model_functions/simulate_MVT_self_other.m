function [neg_log_lik,trial_vars,time_vars] = simulate_MVT_self_other(params,model)
% Birmingham-Leiden Computational Social Cognition (CSC) Summer School 2025
% MVT foraging model
% Emma Scholey, 19 August 2025

% simulate_MVT_self_other is main simulation script including self vs other
% parameters
